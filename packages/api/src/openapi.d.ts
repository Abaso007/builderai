            ...
            200: {
                ...
                content: {
                    "application/json": {
                        ...
                        customerId: string;
                        /** @enum {string} */
                        status: "idle" | "renewing" | "changing" | "canceling" | "expiring" | "invoicing" | "invoiced" | "active" | "trialing" | "canceled" | "expired" | "past_due";
                        active: boolean;
                        planSlug: string;
                        timezone: string;
                        currentCycleStartAt: number;
