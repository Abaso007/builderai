...
function testWindows(): boolean {
  // Modern approach: User-Agent Client Hints
  if (navigator.userAgent) {
    return navigator.userAgent.includes("Windows NT") || navigator.userAgent.includes("Win64")
  }
...
function testLinux(): boolean {
  // Modern approach: User-Agent Client Hints
  if (navigator.userAgent) {
    return navigator.userAgent.includes("Linux") || navigator.userAgent.includes("X11")
  }
