CREATE TABLE "unprice_entitlements" (
	...
	"effective_hard_limit" boolean DEFAULT false NOT NULL,
	"effective_reset_config" json,
	...
	"merging_policy" varchar DEFAULT 'sum' NOT NULL,
	"computed_at" bigint NOT NULL,
	"next_revalidate_at" bigint NOT NULL,
	"version" integer DEFAULT 0 NOT NULL,
	"grants" json,
	"last_usage_update_at" bigint NOT NULL,
	"metadata" json,
...
--> statement-breakpoint
ALTER TABLE "unprice_plan_versions_features" ADD COLUMN "type" varchar DEFAULT 'feature' NOT NULL;--> statement-breakpoint
ALTER TABLE "unprice_plan_versions_features" ADD COLUMN "reset_config" json;--> statement-breakpoint
ALTER TABLE "unprice_plan_versions_features" ADD COLUMN "allow_overage" boolean DEFAULT false NOT NULL;--> statement-breakpoint
ALTER TABLE "unprice_plan_versions_features" ADD COLUMN "notify_usage_threshold" integer DEFAULT 95;--> statement-breakpoint
