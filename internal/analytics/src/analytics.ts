  ...
  public get ingestFeaturesVerification() {
    return this.writeClient.buildIngestEndpoint({
      ...
      event: featureVerificationSchemaV1.omit({
        ...
        usage: true,
        remaining: true,
        entitlement_snapshot_id: true,
        entitlement_version: true,
        entitlement_feature_type: true,
        entitlement_limit: true,
        entitlement_overage_strategy: true,
        entitlement_effective_at: true,
        entitlement_expires_at: true,
